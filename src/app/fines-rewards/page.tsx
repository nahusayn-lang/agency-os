...
export default async function FinesRewardsPage() {
  ...
  // Sabhi fines (sabki, agar admin hai) — category attach karne ke liye
  // strikes.reason bhi saath fetch karte hain.
  ...
  // Payment Review — sabki "submitted" fines, founder ki apni bhi shaamil.
